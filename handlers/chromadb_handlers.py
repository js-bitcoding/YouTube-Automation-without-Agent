...
from utils.external_apis import get_image_description, fetch_scraped_data
    ...
    try:
        ...
        try:
            if file_type == "png" or file_type == "jpeg" or file_type == "jpg":
                image_info = get_image_description(file_path)
                document_chunks = split_into_chunks(image_info)
